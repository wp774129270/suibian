  ...
  <div>
    ...
    <el-card>
      <el-row :gutter="20">
        ...
        ></el-col>
        <el-col :span="4"><el-button type="primary" @click="goAddpage">添加商品</el-button></el-col></el-row
      >
      <!-- tabel表格区域 -->
      <el-table :data="goodslist" border stripe>
        ...
        <el-table-column label="创建时间" prop="add_time" v-slot="scope">
      ...
      <!-- 分页区域 -->
      <el-pagination @size-change="handleSizeChange" @current-change="handleCurrentChange" :current-page="queryInfo.pagenum" :page-sizes="[8, 16, 24, 32]" :page-size="queryInfo.pagesizes" layout="total, sizes, prev, pager, next, jumper" :total="total" background> </el-pagination>
    </el-card>
  </div>
</template>
